 ...
 *
 */
/** Filename: TFA9867N2_tfafieldnames.h
 *  This file was generated automatically on 05/25/26 at 10:54:35. 
 *  Source file: TFA9867N2_GPA3_N2A0_I2C_RegisterMap.xlsx
 */

#ifndef _TFA9867_TFAFIELDNAMES_N2_H
#define _TFA9867_TFAFIELDNAMES_N2_H


#define TFA9867N2A0_I2CVERSION    21
#define TFA9867N2A1_I2CVERSION    21
#define TFA9867N2A2_I2CVERSION    21

typedef enum tfa9867N2BfEnumList {
    TFA9867N2_BF_PWDN  = 0x0000,    /*!< Power-down selection                               */
    TFA9867N2_BF_I2CR  = 0x0010,    /*!< I2C reset - auto clear                             */
    TFA9867N2_BF_JGLEN = 0x0020,    /*!< JINGLE enable                                      */
    TFA9867N2_BF_AMPE  = 0x0030,    /*!< Activate amplifier                                 */
    TFA9867N2_BF_DCA   = 0x0040,    /*!< Activate DC-to-DC converter                        */
    TFA9867N2_BF_EAMPHZEN= 0x0050,    /*!< Amplifer outputs state when OFF                    */
    TFA9867N2_BF_BYPDYUVP= 0x0060,    /*!< Enable dynamic uvp                                 */
    TFA9867N2_BF_INTP  = 0x0071,    /*!< Interrupt pin configuration                        */
    TFA9867N2_BF_QALARM= 0x0090,    /*!< Device response to Qpump OK flag                   */
    TFA9867N2_BF_BYPUVP= 0x00a0,    /*!< Bypass UVP                                         */
    TFA9867N2_BF_BYPOCP= 0x00b0,    /*!< Bypass OCP                                         */
    TFA9867N2_BF_QPUMPOKEN= 0x00c0,    /*!< Low-drive   response to Qpump OK flag              */
    TFA9867N2_BF_AMPQOKEN= 0x00d0,    /*!< Low-power response to Qpump OK flag                */
    TFA9867N2_BF_ENPLLSYNC= 0x00e0,    /*!< Manager control for enabling synchronisation with PLL FS */
    TFA9867N2_BF_COORHYS= 0x00f0,    /*!< Select hysteresis for clock range detector         */
    TFA9867N2_BF_MANSCONF= 0x0120,    /*!< I2C configured                                     */
    TFA9867N2_BF_MUTESKIP= 0x0150,    /*!< Bypass mute sequence                               */
    TFA9867N2_BF_MUTETO= 0x0160,    /*!< Timeout mute sequence                              */
    TFA9867N2_BF_MANROBOD= 0x0170,    /*!< Device response to BOD                             */
    TFA9867N2_BF_JGLCFG= 0x0181,    /*!< Jingle configuration                               */
    TFA9867N2_BF_MANEDCTH= 0x01d0,    /*!< Device response to too-high DC level flag (DCTH is 1) */
    TFA9867N2_BF_LPCEN = 0x01e0,    /*!< LPC  mode  enable                                  */
    TFA9867N2_BF_CSVSENLP= 0x01f0,    /*!< CSVS in Low-power mode                             */
    TFA9867N2_BF_AUDFS = 0x0203,    /*!< Sample rate (Fs)                                   */
    TFA9867N2_BF_FRACTDEL= 0x0256,    /*!< V/I fractional delay                               */
    TFA9867N2_BF_REV   = 0x030f,    /*!< Product                                            */
    TFA9867N2_BF_REFCKEXT= 0x0401,    /*!< PLL external ref clock                             */
    TFA9867N2_BF_BYTDMGLF= 0x0420,    /*!< Bypass TDM FS/BCK/DATAI giltch filter              */
    TFA9867N2_BF_REFCKMULT= 0x0431,    /*!< PLL ref clock selection                            */
    TFA9867N2_BF_MANAOOSC= 0x0460,    /*!< Internal oscillator control during power down mode */
    TFA9867N2_BF_FSSYNCEN= 0x0480,    /*!< Enable FS synchronisation for clock divider        */
    TFA9867N2_BF_CLKREFSYNCEN= 0x0490,    /*!< Enable PLL reference clock synchronisation for clock divider */
    TFA9867N2_BF_PWMFREQ= 0x04a0,    /*!< PWM output frequency select                        */
    TFA9867N2_BF_CGUSYNCDCG= 0x0500,    /*!< Clock gating control for CGU synchronisation module */
    TFA9867N2_BF_IPMBYP= 0x0510,    /*!< Bypass ipm synchromizser in DPSA block             */
    TFA9867N2_BF_DEVCAT= 0x0607,    /*!< Product category                                   */
    TFA9867N2_BF_DEVREV= 0x0687,    /*!< Version                                            */
    TFA9867N2_BF_VDDS  = 0x1000,    /*!< POR (sticky flag, clear on write a '1')            */
    TFA9867N2_BF_OTDS  = 0x1010,    /*!< OTP alarm (sticky flag,  clear on write a '1')     */
    TFA9867N2_BF_UVDS  = 0x1020,    /*!< UVP alarm (sticky flag,  clear on write a '1')     */
    TFA9867N2_BF_OVDS  = 0x1030,    /*!< OVP alarm (sticky flag,  clear on write a '1')     */
    TFA9867N2_BF_OCDS  = 0x1040,    /*!< OCP amplifier (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_NOCLK = 0x1050,    /*!< Lost clock (sticky flag,  clear on write a '1')    */
    TFA9867N2_BF_CLKOOR= 0x1060,    /*!< External clock status (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_DCOCPOK= 0x1070,    /*!< Booster input current reaching DCMCC (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_VDDPOVDS= 0x1080,    /*!< VDDP OVP alarm (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_OCPOMN= 0x1090,    /*!< OCPOK Minion nmos  (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_OCPOMP= 0x10a0,    /*!< OCPOK Minion pmos (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_OCPOAP= 0x10b0,    /*!< OCPOK High side OUTP (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_OCPOAN= 0x10c0,    /*!< OCPOK  High side OUTN (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_OCPOBP= 0x10d0,    /*!< OCPOK  Low side OUTP (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_OCPOBN= 0x10e0,    /*!< OCPOK Low side OUTN (sticky flag,  clear on write a '1')  */
    TFA9867N2_BF_DCTH  = 0x10f0,    /*!< DC level on voltage sense too high (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_CLKS  = 0x1100,    /*!< Clocks stable                                      */
    TFA9867N2_BF_OTPB  = 0x1110,    /*!< EFUSE busy                                         */
    TFA9867N2_BF_TDMERR= 0x1120,    /*!< TDM error                                          */
    TFA9867N2_BF_LPMS  = 0x1130,    /*!< Flag in low-power mode                             */
    TFA9867N2_BF_LNMS  = 0x1140,    /*!< Flag in low-noise mode                             */
    TFA9867N2_BF_FWRMS = 0x1150,    /*!< Flag in follower mode                              */
    TFA9867N2_BF_BSTMS = 0x1160,    /*!< Flag in boost mode                                 */
    TFA9867N2_BF_PLLS  = 0x1170,    /*!< PLL lock                                           */
    TFA9867N2_BF_TDMLUTER= 0x1180,    /*!< TDM LUT error                                      */
    TFA9867N2_BF_SWS   = 0x1190,    /*!< Amplifier engage                                   */
    TFA9867N2_BF_AMPS  = 0x11a0,    /*!< Amplifier enable                                   */
    TFA9867N2_BF_AREFS = 0x11b0,    /*!< References enable                                  */
    TFA9867N2_BF_CLIPS = 0x11c0,    /*!< Amplifier clipping                                 */
    TFA9867N2_BF_VGBS  = 0x11e0,    /*!< Vddp greater than vbat                             */
    TFA9867N2_BF_FLGBSS= 0x11f0,    /*!< BSS flag                                           */
    TFA9867N2_BF_MANSTATE= 0x1203,    /*!< Device manager status                              */
    TFA9867N2_BF_AMPSTE= 0x1243,    /*!< Amplifier control status                           */
    TFA9867N2_BF_TDMSTAT= 0x1282,    /*!< TDM status bits                                    */
    TFA9867N2_BF_QPCLKSTS= 0x12b1,    /*!< QPUMP clock status                                 */
    TFA9867N2_BF_WAITSYNC= 0x12d0,    /*!< CGU and PLL synchronisation status flag from CGU   */
    TFA9867N2_BF_LDMS  = 0x12e0,    /*!< Flag in Low-drive mode                             */
    TFA9867N2_BF_GPIOS = 0x12f0,    /*!< Flag gpio status                                   */
    TFA9867N2_BF_BODNOK= 0x1300,    /*!< BOD Flag VDD NOT OK (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_QPFAIL= 0x1310,    /*!< QPUMP Fail Flag (sticky flag,  clear on write a '1') */
    TFA9867N2_BF_JSEQBUSY= 0x1320,    /*!< Sequency busy                                      */
    TFA9867N2_BF_BATS  = 0x1509,    /*!< Battery voltage monitoring (V)                     */
    TFA9867N2_BF_TEMPS = 0x1608,    /*!< IC temperature monitoring (C)                      */
    TFA9867N2_BF_VDDPS = 0x1709,    /*!< Amplifier supply / booster voltage monitoring (V)  */
    TFA9867N2_BF_VDDA  = 0x1b09,    /*!< vdda voltage monitoring (V)                        */
    TFA9867N2_BF_TDME  = 0x2000,    /*!< Enable interface                                   */
    TFA9867N2_BF_AMPINSEL= 0x2011,    /*!< Amplifier input selection                          */
    TFA9867N2_BF_INPLEV= 0x2030,    /*!< TDM output attenuation                             */
    TFA9867N2_BF_TDMCLINV= 0x2040,    /*!< Reception data to BCK clock                        */
    TFA9867N2_BF_TDMFSPOL= 0x2050,    /*!< FS polarity                                        */
    TFA9867N2_BF_TDMSLOTS= 0x2061,    /*!< N slots in Frame                                   */
    TFA9867N2_BF_TDMSLLN= 0x2081,    /*!< N bits in slot                                     */
    TFA9867N2_BF_TDMSSIZE= 0x20a1,    /*!< Sample size per slot                               */
    TFA9867N2_BF_TDMNBCK= 0x20c3,    /*!< N BCKs in FS                                       */
    TFA9867N2_BF_TDMDEL= 0x2100,    /*!< Data delay to FS                                   */
    TFA9867N2_BF_TDMADJ= 0x2110,    /*!< Data adjustment                                    */
    TFA9867N2_BF_TDMSPKE= 0x2120,    /*!< Control audio TDM input channel 0                  */
    TFA9867N2_BF_TDMDCE= 0x2130,    /*!< Control audio TDM input channel 1                  */
    TFA9867N2_BF_TDMSRC0E= 0x2140,    /*!< Control TDM source0 data channel                   */
    TFA9867N2_BF_TDMSRC1E= 0x2150,    /*!< Control TDM source1 data channel                   */
    TFA9867N2_BF_TDMSRC2E= 0x2160,    /*!< Control TDM source2 data channel                   */
    TFA9867N2_BF_TDMSPKS= 0x2183,    /*!< TDM slot for input channel 0                       */
    TFA9867N2_BF_TDMDCS= 0x21c3,    /*!< TDM slot for input channel 1                       */
    TFA9867N2_BF_TDMSRC0S= 0x2203,    /*!< Slot position of TDM source0 channel data          */
    TFA9867N2_BF_TDMSRC1S= 0x2243,    /*!< Slot position of TDM source1 channel data          */
    TFA9867N2_BF_TDMSRC2S= 0x2283,    /*!< Slot position of TDM source2 channel data          */
    TFA9867N2_BF_ISTVDDS= 0x4000,    /*!< Interrupt status POR                               */
    TFA9867N2_BF_ISTBSTOC= 0x4010,    /*!< Interrupt status DCDC OCP alarm                    */
    TFA9867N2_BF_ISTOTDS= 0x4020,    /*!< Interrupt status OTP alarm                         */
    TFA9867N2_BF_ISTOCPR= 0x4030,    /*!< Interrupt status OCP alarm                         */
    TFA9867N2_BF_ISTUVDS= 0x4040,    /*!< Interrupt status UVP alarm                         */
    TFA9867N2_BF_ISTTDMER= 0x4050,    /*!< Interrupt status TDM error                         */
    TFA9867N2_BF_ISTNOCLK= 0x4060,    /*!< Interrupt status lost clock                        */
    TFA9867N2_BF_ISTDCTH= 0x4070,    /*!< Interrupt status dc too-high                       */
    TFA9867N2_BF_ISTBODNOK= 0x4080,    /*!< Interrupt status brown-out detected                */
    TFA9867N2_BF_ISTCOOR= 0x4090,    /*!< Interrupt status clock out of range                */
    TFA9867N2_BF_ISTOVDS= 0x40a0,    /*!< Interrupt status OVP alarm                         */
    TFA9867N2_BF_ISTQPFAIL= 0x40b0,    /*!< Interrupt status qpump failure                     */
    TFA9867N2_BF_ISTVDDPOVDS= 0x40c0,    /*!< Interrupt status VDDP OVP alarm                    */
    TFA9867N2_BF_ICLVDDS= 0x4400,    /*!< Clear interrupt status POR                         */
    TFA9867N2_BF_ICLBSTOC= 0x4410,    /*!< Clear interrupt status DCDC OCP                    */
    TFA9867N2_BF_ICLOTDS= 0x4420,    /*!< Clear interrupt status OTP alarm                   */
    TFA9867N2_BF_ICLOCPR= 0x4430,    /*!< Clear interrupt status OCP alarm                   */
    TFA9867N2_BF_ICLUVDS= 0x4440,    /*!< Clear interrupt status UVP alarm                   */
    TFA9867N2_BF_ICLTDMER= 0x4450,    /*!< Clear interrupt status TDM error                   */
    TFA9867N2_BF_ICLNOCLK= 0x4460,    /*!< Clear interrupt status lost clk                    */
    TFA9867N2_BF_ICLDCTH= 0x4470,    /*!< Clear interrupt status dc too-high                 */
    TFA9867N2_BF_ICLBODNOK= 0x4480,    /*!< Clear interrupt status brown-out detected          */
    TFA9867N2_BF_ICLCOOR= 0x4490,    /*!< Clear interrupt status clock out of range          */
    TFA9867N2_BF_ICLOVDS= 0x44a0,    /*!< Clear interrupt status OVP alarm                   */
    TFA9867N2_BF_ICLQPFAIL= 0x44b0,    /*!< Clear interrupt status qpump failure               */
    TFA9867N2_BF_ICLVDDPOVDS= 0x44c0,    /*!< Clear interrupt status VDDP OVP alarm              */
    TFA9867N2_BF_IEVDDS= 0x4800,    /*!< Enable interrupt POR                               */
    TFA9867N2_BF_IEBSTOC= 0x4810,    /*!< Enable interrupt DCDC OCP                          */
    TFA9867N2_BF_IEOTDS= 0x4820,    /*!< Enable interrupt OTP alarm                         */
    TFA9867N2_BF_IEOCPR= 0x4830,    /*!< Enable interrupt OCP alarm                         */
    TFA9867N2_BF_IEUVDS= 0x4840,    /*!< Enable interrupt UVP alarm                         */
    TFA9867N2_BF_IETDMER= 0x4850,    /*!< Enable interrupt TDM error                         */
    TFA9867N2_BF_IENOCLK= 0x4860,    /*!< Enable interrupt lost clk                          */
    TFA9867N2_BF_IEDCTH= 0x4870,    /*!< Enable interrupt dc too-high                       */
    TFA9867N2_BF_IEBODNOK= 0x4880,    /*!< Enable interrupt brown-out detect                  */
    TFA9867N2_BF_IECOOR= 0x4890,    /*!< Enable interrupt clock out of range                */
    TFA9867N2_BF_IEOVDS= 0x48a0,    /*!< Enable interrupt OVP alarm                         */
    TFA9867N2_BF_IEQPFAIL= 0x48b0,    /*!< Enable interrupt qpump failure                     */
    TFA9867N2_BF_IEVDDPOVDS= 0x48c0,    /*!< Enable interrupt VDDP OVP alarm                    */
    TFA9867N2_BF_IPOVDDS= 0x4c00,    /*!< Interrupt polarity POR                             */
    TFA9867N2_BF_IPOBSTOC= 0x4c10,    /*!< Interrupt polarity DCDC OCP                        */
    TFA9867N2_BF_IPOOTDS= 0x4c20,    /*!< Interrupt polarity OTP alarm                       */
    TFA9867N2_BF_IPOOCPR= 0x4c30,    /*!< Interrupt polarity OCP alarm                       */
    TFA9867N2_BF_IPOUVDS= 0x4c40,    /*!< Interrupt polarity UVP alarm                       */
    TFA9867N2_BF_IPOTDMER= 0x4c50,    /*!< Interrupt polarity TDM error                       */
    TFA9867N2_BF_IPONOCLK= 0x4c60,    /*!< Interrupt polarity lost clk                        */
    TFA9867N2_BF_IPODCTH= 0x4c70,    /*!< Interrupt polarity dc too-high                     */
    TFA9867N2_BF_IPOBODNOK= 0x4c80,    /*!< Interrupt polarity brown-out detect                */
    TFA9867N2_BF_IPOCOOR= 0x4c90,    /*!< Interrupt polarity clock out of range              */
    TFA9867N2_BF_IPOOVDS= 0x4ca0,    /*!< Interrupt polarity OVP alarm                       */
    TFA9867N2_BF_IPOQPFAIL= 0x4cb0,    /*!< Interrupt polarity qpump failure                   */
    TFA9867N2_BF_IPOVDDPOVDS= 0x4cc0,    /*!< Interrupt polarity vddp OVP alarm                  */
    TFA9867N2_BF_BSSCLRST= 0x50d0,    /*!< Reset clipper  auto-clear                          */
    TFA9867N2_BF_BSSR  = 0x50e0,    /*!< Battery voltage read out in BATS bitfield          */
    TFA9867N2_BF_BSSBY = 0x50f0,    /*!< Bypass battery safeguard                           */
    TFA9867N2_BF_DCDITH= 0x5140,    /*!< DC dithering selection                             */
    TFA9867N2_BF_HPFBYP= 0x5150,    /*!< Bypass HPF                                         */
    TFA9867N2_BF_PWMPH = 0x5203,    /*!< Select pwm phase wrt TDM_FS signal                 */
    TFA9867N2_BF_AMPGAIN= 0x5257,    /*!< Amplifier gain                                     */
    TFA9867N2_BF_BYPDLYLINE= 0x52f0,    /*!< Bypass the interpolator delay line                 */
    TFA9867N2_BF_BSTSLPHS= 0x54a2,    /*!< Slope in bst power stage  high side                                                      */
    TFA9867N2_BF_BSTSLPLS= 0x54d2,    /*!< Slope in bst power stage  low side                                                      */
    TFA9867N2_BF_BSSMVBS= 0x5a00,    /*!< Min_vbat source select                             */
    TFA9867N2_BF_BSST  = 0x5a53,    /*!< BSS threshold Vbat value (reducing gain)           */
    TFA9867N2_BF_BSSAR = 0x5a91,    /*!< BSS attack rate (reducing gain)                    */
    TFA9867N2_BF_BSSRR = 0x5ab3,    /*!< BSS release rate  (reducing gain)                  */
    TFA9867N2_BF_BSSMULT= 0x5af0,    /*!< Multiply attack rate by 8                          */
    TFA9867N2_BF_BSSHT = 0x5b03,    /*!< BSS hold time (reducing gain)                      */
    TFA9867N2_BF_BSSS  = 0x5b41,    /*!< BSS steepness (reducing gain)                      */
    TFA9867N2_BF_BSSRL = 0x5b62,    /*!< BSS allowed reduction level (reducing gain)        */
    TFA9867N2_BF_BSSDCT= 0x5b93,    /*!< BSS threshold Vbat value (reducing DCMCC)          */
    TFA9867N2_BF_BSSDCAR= 0x5bd1,    /*!< BSS attack rate  (reducing DCMCC)                  */
    TFA9867N2_BF_DUALCELL= 0x5bf0,    /*!< Single-cell/Dual-cell Battery                      */
    TFA9867N2_BF_BSSDCRR= 0x5c03,    /*!< BSS release rate  (reducing DCMCC)                 */
    TFA9867N2_BF_BSSDCHT= 0x5c43,    /*!< BSS hold time (reducing DCMCC)                     */
    TFA9867N2_BF_BSSDCS= 0x5c81,    /*!< Battery supply safeguard steepness (reducing DCMCC) */
    TFA9867N2_BF_BSSDCRL= 0x5ca2,    /*!< BSS allowed reduction level (reducing DCMCC)       */
    TFA9867N2_BF_DCLIPFLS= 0x5cd1,    /*!< Select source for BSS flag                         */
    TFA9867N2_BF_BSSBYDB= 0x5cf0,    /*!< Bypass the effect of BSS on boost voltage          */
    TFA9867N2_BF_OVDEFF= 0x5d05,    /*!< Overdrive. Efficiency of the class D amplifier     */
    TFA9867N2_BF_OVDRL = 0x5d66,    /*!< Overdrive. Load resistance                         */
    TFA9867N2_BF_OVDGP = 0x5e05,    /*!< Overdrive. Proportional gain parameter to determine the amount of overboosting */
    TFA9867N2_BF_DCMCC = 0x5e64,    /*!< Battery current limiter initial value              */
    TFA9867N2_BF_TDMSPKG= 0x5f54,    /*!< TDM signal attenuation                             */
    TFA9867N2_BF_IPM   = 0x60e1,    /*!< Idle-power mode control                            */
    TFA9867N2_BF_LDMSEG= 0x62b2,    /*!< Amplifier low-drive   mode                         */
    TFA9867N2_BF_LDM   = 0x63c1,    /*!< Low-drive mode detector control                    */
    TFA9867N2_BF_RCVM  = 0x63e1,    /*!< Handset/Receiver mode                              */
    TFA9867N2_BF_VBATHOLD= 0x6555,    /*!< Select hold time for VBAT(min./max.)               */
    TFA9867N2_BF_VBATMAX= 0x65b0,    /*!< Select between vbat minimum or maximum for Chip Sense output on TDM  VBAT(min./max.) */
    TFA9867N2_BF_LPM   = 0x66e1,    /*!< Low-power mode control                             */
    TFA9867N2_BF_LPMTH = 0x6705,    /*!< Low-power mode  amplitude trigger level            */
    TFA9867N2_BF_TDMSRCMAP= 0x6802,    /*!< TDM source mapping                                 */
    TFA9867N2_BF_TDMSRCAS= 0x6842,    /*!< Sensed value A                                     */
    TFA9867N2_BF_TDMSRCBS= 0x6872,    /*!< Sensed value B                                     */
    TFA9867N2_BF_TDMSRCACLIP= 0x68a1,    /*!< Clip flag information with combined clip flag      */
    TFA9867N2_BF_TDMSRCCS= 0x6902,    /*!< Sensed value C                                     */
    TFA9867N2_BF_TDMSRCDS= 0x6932,    /*!< Sensed value D                                     */
    TFA9867N2_BF_TDMSRCES= 0x6962,    /*!< Sensed value E                                     */
    TFA9867N2_BF_TDMVBAT= 0x6990,    /*!< Select vbat to return to TDM interface             */
    TFA9867N2_BF_LPMBAT= 0x6a05,    /*!< Headrom between signal and VDDA to switch to/from low power mode when LPMTM is set to 1  */
    TFA9867N2_BF_LPMTM = 0x6a60,    /*!< Low power threshold mode                           */
    TFA9867N2_BF_IPMS  = 0x6e00,    /*!< Idle-power mode                                    */
    TFA9867N2_BF_LVLCLPPWM= 0x6f72,    /*!< Clip detect threshold control                      */
    TFA9867N2_BF_DCIE  = 0x7060,    /*!< Adaptive boost mode                                */
    TFA9867N2_BF_DCNS  = 0x7400,    /*!< Disable the noise shaper control for the DC-DC control. */
    TFA9867N2_BF_DCNSRST= 0x7410,    /*!< Disable the noise-shaper reset control when an 8-bit value is used for the DC-DC control. */
    TFA9867N2_BF_DCOFFSET= 0x7424,    /*!< Boost headroom  Offset                             */
    TFA9867N2_BF_DCDCSELOFF= 0x7470,    /*!< Selection of  of the dcdc calibration              */
    TFA9867N2_BF_DCHOLD= 0x7494,    /*!< Hold time for booster                              */
    TFA9867N2_BF_DCINT = 0x74e0,    /*!< Selection of data for adaptive boost algorithm, effective only when DCIE is set to 1 */
    TFA9867N2_BF_DCTRIP= 0x7509,    /*!< 1st adaptive boost trip level, effective only when DCIE is set to 1 */
    TFA9867N2_BF_DCTRIPT= 0x75a4,    /*!< Booster headroom gain, increasing headroom when signal amplitude increases */
    TFA9867N2_BF_BYPDCLPF= 0x75f0,    /*!< Bypass control of DC-DC control low-pass filter for quantization noise suppression */
    TFA9867N2_BF_DCVOS = 0x7687,    /*!< Maximum boost voltage                              */
    TFA9867N2_BF_LNMTH = 0x7c05,    /*!< Low-noise mode  amplitude trigger level            */
    TFA9867N2_BF_MUSMODE= 0x7cc0,    /*!< Music mode                                         */
    TFA9867N2_BF_LNM   = 0x7ce1,    /*!< Low-noise Mode control when in Music mode          */
    TFA9867N2_BF_DCPTC = 0x8401,    /*!< Voltage sense dc speaker protection time           */
    TFA9867N2_BF_DCPL  = 0x842c,    /*!< Voltage sense dc speaker protection level          */
    TFA9867N2_BF_DCPROT= 0x84f0,    /*!< Voltage sense dc speaker protection enable         */
    TFA9867N2_BF_EFUSEK= 0xa107,    /*!< EFUSE KEY2 register                                */
    TFA9867N2_BF_KEY1LOCKED= 0xa200,    /*!< Indicates KEY1 is locked                           */
    TFA9867N2_BF_KEY2LOCKED= 0xa210,    /*!< Indicates KEY2 is locked                           */
    TFA9867N2_BF_UVPSET= 0xb103,    /*!< Uvp set                                            */
    TFA9867N2_BF_SWPROFIL= 0xbe0f,    /*!< Software profile data                              */
    TFA9867N2_BF_SWVSTEP= 0xbf0f,    /*!< Software vstep information                         */
    TFA9867N2_BF_PLLPDIV= 0xc934,    /*!< PLL PDIV when pll_use_direct_ctrls set to 1        */
    TFA9867N2_BF_PLLNDIV= 0xc987,    /*!< PLL NDIV when pll_use_direct_ctrls set to 1        */
    TFA9867N2_BF_PLLMDIV= 0xca0f,    /*!< PLL MDIV in PLL when pll_use_direct_ctrls set to 1 */
    TFA9867N2_BF_DCDIS = 0xce30,    /*!< DCDC on/off                                        */
    TFA9867N2_BF_PLLSTRTM= 0xce42,    /*!< PLL startup time selection control                 */
    TFA9867N2_BF_ADC11GAIN= 0xf6a5,    /*!< Adc11b gain compensation setting, compensate factor (2's complement) */
} TFA9867N2BfEnumList_t;
#define TFA9867N2_NAMETABLE static tfaBfName_t Tfa9867N2DatasheetNames[]= {\
   ...
   { 0x150, "MUTESKIP"},    /* Bypass mute sequence                              , */\
   ...
   { 0x431, "REFCKMULT"},    /* PLL ref clock selection                           , */\
   ...
   { 0x1080, "VDDPOVDS"},    /* VDDP OVP alarm (sticky flag,  clear on write a '1'), */\
   ...
   { 0x1b09, "VDDA"},    /* vdda voltage monitoring (V)                       , */\
   ...
   { 0x40c0, "ISTVDDPOVDS"},    /* Interrupt status VDDP OVP alarm                   , */\
   ...
   { 0x44c0, "ICLVDDPOVDS"},    /* Clear interrupt status VDDP OVP alarm             , */\
   ...
   { 0x48c0, "IEVDDPOVDS"},    /* Enable interrupt VDDP OVP alarm                   , */\
   ...
   { 0x4cc0, "IPOVDDPOVDS"},    /* Interrupt polarity vddp OVP alarm                 , */\
   ...
   { 0x54a2, "BSTSLPHS"},    /* Slope in bst power stage  high side                                                     , */\
   { 0x54d2, "BSTSLPLS"},    /* Slope in bst power stage  low side                                                     , */\
   ...
   { 0x5bf0, "DUALCELL"},    /* Single-cell/Dual-cell Battery                     , */\
   ...
   { 0x5e64, "DCMCC"},    /* Battery current limiter initial value             , */\
   ...
   { 0x6a05, "LPMBAT"},    /* Headrom between signal and VDDA to switch to/from low power mode when LPMTM is set to 1 , */\
   { 0x6a60, "LPMTM"},    /* Low power threshold mode                          , */\
...
#define TFA9867N2_BITNAMETABLE static tfaBfName_t Tfa9867N2BitNames[]= {\
   ...
   { 0x150, "bypass_mute"},    /* Bypass mute sequence                              , */\
   ...
   { 0x1a0, "bod_sel"},    /* BOD selection                                     , */\
   { 0x1b1, "bgr_ciff_ibias_sel"},    /* Control amp/alf/ciff itrim current                , */\
   ...
   { 0x431, "pll_clkref_sel"},    /* PLL ref clock selection                           , */\
   ...
   { 0x4b2, "clk_pwm_dly_sel"},    /* Delay on clock da_clk4096fs to tzdac              , */\
   { 0x4e0, "gate_clk_in_low_power"},    /* Enable clock gating in low-power mode             , */\
   ...
   { 0x1080, "flag_vddp_ovpok"},    /* VDDP OVP alarm (sticky flag,  clear on write a '1'), */\
   ...
   { 0x1b09, "vdda_adc"},    /* vdda voltage monitoring (V)                       , */\
   ...
   { 0x40c0, "int_out_flag_vddp_ovpok"},    /* Interrupt status VDDP OVP alarm                   , */\
   ...
   { 0x44c0, "int_in_flag_vddp_ovpok"},    /* Clear interrupt status VDDP OVP alarm             , */\
   ...
   { 0x48c0, "int_enable_flag_vddp_ovpok"},    /* Enable interrupt VDDP OVP alarm                   , */\
   ...
   { 0x4cc0, "int_polarity_flag_vddp_ovpok"},    /* Interrupt polarity vddp OVP alarm                 , */\
   ...
   { 0x5302, "amp_highside_slope"},    /* Amplifier power stage High Side Slope configuration, */\
   { 0x5332, "amp_lowside_slope"},    /* Amplifier power stage Low Side Slope configuration, */\
   { 0x5401, "amp_pst_bbm"},    /* Amplifier break-before-make delay                 , */\
   { 0x5421, "bst_pst_bbm"},    /* Booster break-before-make delay                   , */\
   { 0x5440, "amp_cmfb_path_sel"},    /* CMFB path selection                               , */\
   { 0x5452, "amp_drive"},    /* Drive setting of AMP powerstage when amp_use_direct_ctrls is set to 1, */\
   { 0x5480, "amp_vddpgt5v0_detect_en"},    /* Enable saving current in low side driver when VDDP < 5V, */\
   { 0x5490, "vsup_ocdref_amp_sel"},    /* Select the AMP OCP reference current depending on VDDP, */\
   { 0x54a2, "bst_pst_slope_highside"},    /* Slope in bst power stage  high side                                                     , */\
   { 0x54d2, "bst_pst_slope_lowside"},    /* Slope in bst power stage  low side                                                     , */\
   ...
   { 0x58f0, "byp_post_mult4"},    /* Bypass post divider place in PWM sdm_out process  , */\
   ...
   { 0x5dd0, "bst_en_in_low_power"},    /* Boost enable in low power mode                    , */\
   { 0x5e05, "bst_overdrive_gain"},    /* Overdrive. Proportional gain parameter to determine the amount of overboosting, */\
   { 0x5e64, "bss_dcmcc"},    /* Battery current limiter initial value             , */\
   ...
   { 0x62e0, "byp_drive_low_drive_det"},    /* Bypass low-drive detector                         , */\
   ...
   { 0x67f0, "dis_hp2lp_ns_zc"},    /* Disable zero crossing detection for transition from low to high power, */\
   ...
   { 0x6a05, "low_power_trip_lvl"},    /* Headrom between signal and VDDA to switch to/from low power mode when LPMTM is set to 1 , */\
   { 0x6a60, "low_power_threshold_mode"},    /* Low power threshold mode                          , */\
   ...
   { 0x7841, "bst_nomfreq_oc"},    /* Boost frequency in current mode.                  , */\
   { 0x7860, "bst_lpfm_en"},    /* Enable low-power follower mode for efficiency improvement at low-power, */\
   { 0x7870, "bypass_qpump_gating"},    /* Bypass qpump ok flag gating versus vddp ok flag   , */\
   ...
   { 0x8900, "bypass_v1p8v_gc"},    /* Compensation of cursense as a function of VDDA    , */\
   { 0x8916, "square_b"},    /* Linear coefficient of second order compensation of cursense as a, */\
   { 0x8987, "square_c"},    /* Linear coefficient of second order compensation of cursense as a, */\
   ...
   { 0xb140, "sel_ocp_alarm_bv"},    /* Selection of ocp alarm behavior                   , */\
   { 0xb150, "vsup_vbat_uvp_low"},    /* VBAT UVP                                          , */\
   ...
   { 0xce00, "datai_pu"},    /* DATAI pull-up control, only effective in GPIO mode, */\
   { 0xce10, "datai_pd"},    /* DATAI pull-down control, only effective in GPIO mode, */\
   ...
   { 0xd130, "sel_v1p8v_flt"},    /* Selection VDDA source                             , */\
   { 0xd140, "bypass_lp_v1p8v"},    /* Bypass control for low-pass filter in vdda sensor , */\
   { 0xd150, "hyst_ris_temp"},    /* Over temperature threshold                        , */\
   { 0xd167, "vddp_ocp_cmp"},    /* VDDP threshold to change OCP when low VDDP        , */\
   ...
   { 0xd340, "amp_fpwm_hybrid"},    /* Amplifier hybrid mode ( digital at 768KHz, Analog at 384KHz), */\
   { 0xd360, "amp_large_power_detect"},    /* Enable the CMFF current in TZDAC when amp_use_direct_ctrls is 1, */\
   { 0xd370, "amp_test_vddl1v8"},    /* Vddl1v8 to analog test pin (atbn/p TEST1)         , */\
   { 0xd380, "bst_ocl_disable"},    /* Sisable DCMCC current limiting                    , */\
   { 0xd390, "bst_test_vddl1v8"},    /* Test bit for vddl1v8 observability                , */\
   { 0xd3a0, "bst_test_idac_current"},    /* Test bit for OCL reference current observability  , */\
   { 0xd3b0, "bst_clamp_test"},    /* Clamp test mode disable minimum clamp on feedback node active high, */\
   { 0xd3c0, "atb_hv_gate_ls"},    /* Connect gate low side to atb analog test bus      , */\
   { 0xd3d0, "atbp_vref1v2"},    /* Connect band-gap vref 1.24V to atbp (TEST1)       , */\
   { 0xd3e0, "atbn_vddddiv"},    /* Vdda scaler sense (TEST1)                         , */\
   ...
   { 0xd4f0, "amp_ciff_2order_sel"},    /* 2nd order loop selection                          , */\
   ...
   { 0xda20, "amp_tzdac_cmff_dis_bypass"},    /* Bypass CMFF gating based on signal amplitude      , */\
   ...
   { 0xda50, "amp_lpf_bypass"},    /* Bypass ALF lpf  filter                            , */\
   { 0xda60, "bst_vddpgt5v0_detect_en"},    /* Enable limiter in LS gate driver when VDDP<5V     , */\
   { 0xda72, "qpump_vssq"},    /* Force VREF-VDDP higher than 5V to verifybenefit on efficiency, */\
   { 0xdaa0, "bst_force_flw_enable"},    /* Enable Force the boost in follower mode           , */\
   { 0xdab0, "enbl_chk_bst_vset"},    /* Check bst_vet to control  bst_force_flw           , */\
   { 0xdac2, "bst_fmin"},    /* Booster minimum frequency when bst_use_direct_ctrls is set to 1, */\
   ...
   { 0xdd30, "bst_ocp_offset"},    /* Activate -0.3A offset in OCL/DCMCC                , */\
   ...
   { 0xf0a4, "amp_rfb_trim"},    /* Analog control loop ALF resistance trimming for matching, */\
   { 0xf0f0, "spare_f0_15"},    /* SPARE                                             , */\
...
enum tfa9867n2_irq {
	tfa9867n2_irq_stvdds = 0,
	tfa9867n2_irq_stbstoc = 1,
	tfa9867n2_irq_stotds = 2,
	tfa9867n2_irq_stocpr = 3,
	tfa9867n2_irq_stuvds = 4,
	tfa9867n2_irq_sttdmer = 5,
	tfa9867n2_irq_stnoclk = 6,
	tfa9867n2_irq_stdcth = 7,
	tfa9867n2_irq_stbodnok = 8,
	tfa9867n2_irq_stcoor = 9,
	tfa9867n2_irq_stovds = 10,
	tfa9867n2_irq_stqpfail = 11,
	tfa9867n2_irq_stvddpovds = 12,
	tfa9867n2_irq_max = -1,
	tfa9867n2_irq_all = -1 /* all irqs */};

#define TFA9867N2_IRQ_NAMETABLE static tfaIrqName_t tfa9867n2_irq_names[]= {\
	{0, "STVDDS"},\
	{1, "STBSTOC"},\
	{2, "STOTDS"},\
	{3, "STOCPR"},\
...
#endif /* _TFA9867N2_TFAFIELDNAMES_H */
