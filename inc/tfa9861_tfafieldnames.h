...
#ifndef _TFA9861_TFAFIELDNAMES_H
#define _TFA9861_TFAFIELDNAMES_H


#define TFA9861_I2CVERSION_N1A0 23
#define TFA9861_I2CVERSION_N1A1 4
#define TFA9861_I2CVERSION_N1A2 4
...
typedef enum tfa9861BfEnumList {
    ...
    TFA9861_BF_I2CR  = 0x0010,    /*!< I2C reset - auto clear                             */
    TFA9861_BF_AMPE  = 0x0030,    /*!< Activate amplifier                                 */
    TFA9861_BF_DCA   = 0x0040,    /*!< Activate DC-to-DC converter                        */
    TFA9861_BF_EAMPHZEN= 0x0050,    /*!< Amplifer outputs state when OFF                    */
    TFA9861_BF_BYPDYUVP= 0x0060,    /*!< Enable dynamic uvp                                 */
    TFA9861_BF_INTP  = 0x0071,    /*!< Interrupt pin configuration                        */
    TFA9861_BF_QALARM= 0x0090,    /*!< Device response to Qpump OK flag                   */
    TFA9861_BF_BYPUVP= 0x00a0,    /*!< Bypass UVP                                         */
    TFA9861_BF_BYPOCP= 0x00b0,    /*!< Bypass OCP                                         */
    TFA9861_BF_QPUMPOKEN= 0x00c0,    /*!< Low-drive   response to Qpump OK flag              */
    TFA9861_BF_AMPQOKEN= 0x00d0,    /*!< Rsponse to Qpump OK flag                           */
    TFA9861_BF_ENPLLSYNC= 0x00e0,    /*!< Manager control for enabling synchronisation with PLL FS */
    TFA9861_BF_COORHYS= 0x00f0,    /*!< Select hysteresis for clock range detector         */
    TFA9861_BF_MANSCONF= 0x0120,    /*!< I2C configured                                     */
    TFA9861_BF_MUTETO= 0x0160,    /*!< Timeout mute sequence                              */
    TFA9861_BF_MANROBOD= 0x0170,    /*!< Device response to BOD                             */
    TFA9861_BF_MANEDCTH= 0x01d0,    /*!< Device response to too-high DC level flag (DCTH is 1) */
    TFA9861_BF_AUDFS = 0x0203,    /*!< Sample rate (Fs)                                   */
    TFA9861_BF_FRACTDEL= 0x0247,    /*!< V/I fractional delay                               */
    TFA9861_BF_REV   = 0x030f,    /*!< Product                                            */
    TFA9861_BF_REFCKEXT= 0x0400,    /*!< PLL external reference clock                       */
    TFA9861_BF_BYTDMGLF= 0x0420,    /*!< Bypass TDM FS/BCK/DATAI giltch filter              */
    TFA9861_BF_MANAOOSC= 0x0460,    /*!< Internal oscillator control during power-down mode */
    TFA9861_BF_FSSYNCEN= 0x0480,    /*!< Enable FS synchronisation for clock divider        */
    TFA9861_BF_CLKREFSYNCEN= 0x0490,    /*!< Enable PLL reference clock synchronisation for clock divider */
    TFA9861_BF_PWMFREQ= 0x04a0,    /*!< PWM output frequency select                        */
    TFA9861_BF_CGUSYNCDCG= 0x0500,    /*!< Clock gating control for CGU synchronisation module */
    TFA9861_BF_IPMBYP= 0x0510,    /*!< Bypass ipm synchromizser in DPSA block             */
    TFA9861_BF_DEVCAT= 0x0607,    /*!< Product category                                   */
    TFA9861_BF_DEVREV= 0x0687,    /*!< Version                                            */
    TFA9861_BF_VGAINDELS= 0x0705,    /*!< VS gain  delay step 1/256fs                        */
    TFA9861_BF_VGAINDELL= 0x0761,    /*!< VS gain  delay step 1/16fs                         */
    TFA9861_BF_VDDS  = 0x1000,    /*!< POR (sticky flag, clear on write a '1')            */
    TFA9861_BF_OTDS  = 0x1010,    /*!< OTP alarm (sticky flag,  clear on write a '1')     */
    TFA9861_BF_UVDS  = 0x1020,    /*!< UVP alarm (sticky flag,  clear on write a '1')     */
    TFA9861_BF_OVDS  = 0x1030,    /*!< OVP alarm (sticky flag,  clear on write a '1')     */
    TFA9861_BF_OCDS  = 0x1040,    /*!< OCP amplifier (sticky flag,  clear on write a '1') */
    TFA9861_BF_NOCLK = 0x1050,    /*!< Lost clock (sticky flag,  clear on write a '1')    */
    TFA9861_BF_CLKOOR= 0x1060,    /*!< External clock status (sticky flag,  clear on write a '1') */
    TFA9861_BF_DCOCPOK= 0x1070,    /*!< Booster input current reaching DCMCC (sticky flag,  clear on write a '1') */
    TFA9861_BF_OCPOAP= 0x10b0,    /*!< OCPOK High side OUTP (sticky flag,  clear on write a '1') */
    TFA9861_BF_OCPOAN= 0x10c0,    /*!< OCPOK  High side OUTN (sticky flag,  clear on write a '1') */
    TFA9861_BF_OCPOBP= 0x10d0,    /*!< OCPOK  Low side OUTP (sticky flag,  clear on write a '1') */
    TFA9861_BF_OCPOBN= 0x10e0,    /*!< OCPOK Low side OUTN (sticky flag,  clear on write a '1')  */
    TFA9861_BF_DCTH  = 0x10f0,    /*!< DC level on voltage sense too high (sticky flag,  clear on write a '1') */
    TFA9861_BF_CLKS  = 0x1100,    /*!< Clocks stable                                      */
    TFA9861_BF_OTPB  = 0x1110,    /*!< EFUSE busy                                         */
    TFA9861_BF_TDMERR= 0x1120,    /*!< TDM error                                          */
    TFA9861_BF_LNMS  = 0x1140,    /*!< Device in low-noise mode                           */
    TFA9861_BF_FWRMS = 0x1150,    /*!< Device in follower mode                            */
    TFA9861_BF_BSTMS = 0x1160,    /*!< Device in boost mode                               */
    TFA9861_BF_PLLS  = 0x1170,    /*!< PLL lock                                           */
    TFA9861_BF_TDMLUTER= 0x1180,    /*!< TDM LUT error                                      */
    TFA9861_BF_SWS   = 0x1190,    /*!< Amplifier output status                            */
    TFA9861_BF_AMPS  = 0x11a0,    /*!< Amplifier enable status                            */
    TFA9861_BF_AREFS = 0x11b0,    /*!< References enable status                           */
    TFA9861_BF_CLIPS = 0x11c0,    /*!< Amplifier clipping status                          */
    TFA9861_BF_PMOSS = 0x11d0,    /*!< VBAT to VBST switch PMOS state                     */
    TFA9861_BF_VGBS  = 0x11e0,    /*!< Vddp greater than vbat status                      */
    TFA9861_BF_FLGBSS= 0x11f0,    /*!< BSS flag status                                    */
    TFA9861_BF_MANSTATE= 0x1203,    /*!< Device manager status                              */
    TFA9861_BF_AMPSTE= 0x1243,    /*!< Amplifier control status                           */
    TFA9861_BF_TDMSTAT= 0x1282,    /*!< TDM status bits                                    */
    TFA9861_BF_QPCLKSTS= 0x12b1,    /*!< QPUMP clock status                                 */
    TFA9861_BF_WAITSYNC= 0x12d0,    /*!< CGU and PLL synchronisation status flag from CGU   */
    TFA9861_BF_LDMS  = 0x12e0,    /*!< Device in low-drive mode                           */
    TFA9861_BF_BODNOK= 0x1300,    /*!< BOD Flag VDD NOT OK (sticky flag,  clear on write a '1') */
    TFA9861_BF_QPFAIL= 0x1310,    /*!< QPUMP Fail Flag (sticky flag,  clear on write a '1') */
    TFA9861_BF_BATS  = 0x1509,    /*!< Battery voltage monitoring (V)                     */
    TFA9861_BF_TEMPS = 0x1608,    /*!< IC Temperature monitoring (C)                      */
    TFA9861_BF_VDDPS = 0x1709,    /*!< Amplifier supply / booster voltage monitoring (V)  */
    TFA9861_BF_TDME  = 0x2000,    /*!< Enable interface                                   */
    TFA9861_BF_AMPINSEL= 0x2011,    /*!< Amplifier input selection                          */
    TFA9861_BF_INPLEV= 0x2030,    /*!< TDM output attenuation                             */
    TFA9861_BF_TDMCLINV= 0x2040,    /*!< Reception data to BCK clock                        */
    TFA9861_BF_TDMFSPOL= 0x2050,    /*!< FS polarity                                        */
    TFA9861_BF_TDMSLOTS= 0x2061,    /*!< N slots in Frame                                   */
    TFA9861_BF_TDMSLLN= 0x2081,    /*!< N bits in slot                                     */
    TFA9861_BF_TDMSSIZE= 0x20a1,    /*!< Sample size per slot                               */
    TFA9861_BF_TDMNBCK= 0x20c3,    /*!< N BCKs in FS                                       */
    TFA9861_BF_TDMDEL= 0x2100,    /*!< Data delay to FS                                   */
    TFA9861_BF_TDMADJ= 0x2110,    /*!< Data adjustment                                    */
    TFA9861_BF_TDMSPKE= 0x2120,    /*!< Control audio TDM input channel 0                  */
    TFA9861_BF_TDMDCE= 0x2130,    /*!< Control audio TDM input channel 1                  */
    TFA9861_BF_TDMSRC0E= 0x2140,    /*!< Control TDM source0 data channel                   */
    TFA9861_BF_TDMSRC1E= 0x2150,    /*!< Control TDM source1 data channel                   */
    TFA9861_BF_TDMSRC2E= 0x2160,    /*!< Control TDM source2 data channel                   */
    TFA9861_BF_TDMSPKS= 0x2183,    /*!< TDM slot for input channel 0                       */
    TFA9861_BF_TDMDCS= 0x21c3,    /*!< TDM slot for input channel 1                       */
    TFA9861_BF_TDMSRC0S= 0x2203,    /*!< Slot position of TDM source0 channel data          */
    TFA9861_BF_TDMSRC1S= 0x2243,    /*!< Slot position of TDM source1 channel data          */
    TFA9861_BF_TDMSRC2S= 0x2283,    /*!< Slot position of TDM source2 channel data          */
    TFA9861_BF_ISTVDDS= 0x4000,    /*!< Interrupt status POR                               */
    TFA9861_BF_ISTBSTOC= 0x4010,    /*!< Interrupt status DCDC OCP alarm                    */
    TFA9861_BF_ISTOTDS= 0x4020,    /*!< Interrupt status OTP alarm                         */
    TFA9861_BF_ISTOCPR= 0x4030,    /*!< Interrupt status OCP alarm                         */
    TFA9861_BF_ISTUVDS= 0x4040,    /*!< Interrupt status UVP alarm                         */
    TFA9861_BF_ISTTDMER= 0x4050,    /*!< Interrupt status TDM error                         */
    TFA9861_BF_ISTNOCLK= 0x4060,    /*!< Interrupt status lost clock                        */
    TFA9861_BF_ISTDCTH= 0x4070,    /*!< Interrupt status dc too-high                       */
    TFA9861_BF_ISTBODNOK= 0x4080,    /*!< Interrupt status brown-out detected                */
    TFA9861_BF_ISTCOOR= 0x4090,    /*!< Interrupt status clock out of range                */
    TFA9861_BF_ISTOVDS= 0x40a0,    /*!< Interrupt status OVP alarm                         */
    TFA9861_BF_ISTQPFAIL= 0x40b0,    /*!< Interrupt status qpump failure                     */
    TFA9861_BF_ICLVDDS= 0x4400,    /*!< Clear interrupt status POR                         */
    TFA9861_BF_ICLBSTOC= 0x4410,    /*!< Clear interrupt status DCDC OCP                    */
    TFA9861_BF_ICLOTDS= 0x4420,    /*!< Clear interrupt status OTP alarm                   */
    TFA9861_BF_ICLOCPR= 0x4430,    /*!< Clear interrupt status OCP alarm                   */
    TFA9861_BF_ICLUVDS= 0x4440,    /*!< Clear interrupt status UVP alarm                   */
    TFA9861_BF_ICLTDMER= 0x4450,    /*!< Clear interrupt status TDM error                   */
    TFA9861_BF_ICLNOCLK= 0x4460,    /*!< Clear interrupt status lost clk                    */
    TFA9861_BF_ICLDCTH= 0x4470,    /*!< Clear interrupt status dc too-high                 */
    TFA9861_BF_ICLBODNOK= 0x4480,    /*!< Clear interrupt status brown-out detected          */
    TFA9861_BF_ICLCOOR= 0x4490,    /*!< Clear interrupt status clock out of range          */
    TFA9861_BF_ICLOVDS= 0x44a0,    /*!< Clear interrupt status OVP alarm                   */
    TFA9861_BF_ICLQPFAIL= 0x44b0,    /*!< Clear interrupt status qpump failure               */
    TFA9861_BF_IEVDDS= 0x4800,    /*!< Enable interrupt POR                               */
    TFA9861_BF_IEBSTOC= 0x4810,    /*!< Enable interrupt DCDC OCP                          */
    TFA9861_BF_IEOTDS= 0x4820,    /*!< Enable interrupt OTP alarm                         */
    TFA9861_BF_IEOCPR= 0x4830,    /*!< Enable interrupt OCP alarm                         */
    TFA9861_BF_IEUVDS= 0x4840,    /*!< Enable interrupt UVP alarm                         */
    TFA9861_BF_IETDMER= 0x4850,    /*!< Enable interrupt TDM error                         */
    TFA9861_BF_IENOCLK= 0x4860,    /*!< Enable interrupt lost clk                          */
    TFA9861_BF_IEDCTH= 0x4870,    /*!< Enable interrupt dc too-high                       */
    TFA9861_BF_IEBODNOK= 0x4880,    /*!< Enable interrupt brown-out detected                */
    TFA9861_BF_IECOOR= 0x4890,    /*!< Enable interrupt clock out of range                */
    TFA9861_BF_IEOVDS= 0x48a0,    /*!< Enable interrupt OVP alarm                         */
    TFA9861_BF_IEQPFAIL= 0x48b0,    /*!< Enable interrupt qpump failure                     */
    TFA9861_BF_IPOVDDS= 0x4c00,    /*!< Interrupt polarity POR                             */
    TFA9861_BF_IPOBSTOC= 0x4c10,    /*!< Interrupt polarity DCDC OCP                        */
    TFA9861_BF_IPOOTDS= 0x4c20,    /*!< Interrupt polarity OTP alarm                       */
    TFA9861_BF_IPOOCPR= 0x4c30,    /*!< Interrupt polarity OCP alarm                       */
    TFA9861_BF_IPOUVDS= 0x4c40,    /*!< Interrupt polarity UVP alarm                       */
    TFA9861_BF_IPOTDMER= 0x4c50,    /*!< Interrupt polarity TDM error                       */
    TFA9861_BF_IPONOCLK= 0x4c60,    /*!< Interrupt polarity lost clk                        */
    TFA9861_BF_IPODCTH= 0x4c70,    /*!< Interrupt polarity dc too-high                     */
    TFA9861_BF_IPOBODNOK= 0x4c80,    /*!< Interrupt polarity brown-out detected              */
    TFA9861_BF_IPOCOOR= 0x4c90,    /*!< Interrupt polarity clock out of range              */
    TFA9861_BF_IPOOVDS= 0x4ca0,    /*!< Interrupt polarity OVP alarm                       */
    TFA9861_BF_IPOQPFAIL= 0x4cb0,    /*!< Interrupt polarity qpump failure                   */
    TFA9861_BF_BSSCLRST= 0x50d0,    /*!< Reset clipper  auto-clear                          */
    TFA9861_BF_BSSR  = 0x50e0,    /*!< Battery voltage read out in BATS bitfield          */
    TFA9861_BF_BSSBY = 0x50f0,    /*!< Bypass battery safeguard                           */
    TFA9861_BF_DCDITH= 0x5140,    /*!< DC dithering selection                             */
    TFA9861_BF_HPFBYP= 0x5150,    /*!< Bypass High Pass Filter in audio path              */
    TFA9861_BF_PWMPH = 0x5203,    /*!< Select pwm phase wrt TDM_FS signal                 */
    TFA9861_BF_AMPGAIN= 0x5257,    /*!< Amplifier gain                                     */
    TFA9861_BF_BYPDLYLINE= 0x52f0,    /*!< Bypass the interpolator delay line                 */
    TFA9861_BF_AMPDRV= 0x5450,    /*!< Drive setting of AMP powerstage when amp_use_direct_ctrls  */
    TFA9861_BF_AMPSLP= 0x5481,    /*!< Amplifier slope control                            */
    TFA9861_BF_BSTSLP= 0x54a1,    /*!< Booster slope control                              */
    TFA9861_BF_BSSMVBS= 0x5a00,    /*!< Min._vbat source select                            */
    TFA9861_BF_BSST  = 0x5a53,    /*!< BSS threshold Vbat value (reducing gain)           */
    TFA9861_BF_BSSAR = 0x5a91,    /*!< BSS attack rate (reducing gain)                    */
    TFA9861_BF_BSSRR = 0x5ab3,    /*!< BSS release rate  (reducing gain)                  */
    TFA9861_BF_BSSMULT= 0x5af0,    /*!< Multiply attack rate by 8                          */
    TFA9861_BF_BSSHT = 0x5b03,    /*!< BSS hold time (reducing gain)                      */
    TFA9861_BF_BSSS  = 0x5b41,    /*!< BSS steepness (reducing gain)                      */
    TFA9861_BF_BSSRL = 0x5b62,    /*!< BSS allowed reduction level (reducing gain)        */
    TFA9861_BF_BSSDCT= 0x5b93,    /*!< BSS threshold Vbat value (reducing DCMCC)          */
    TFA9861_BF_BSSDCAR= 0x5bd1,    /*!< BSS attack rate  (reducing DCMCC)                  */
    TFA9861_BF_BSSDCRR= 0x5c03,    /*!< BSS release rate  (reducing DCMCC)                 */
    TFA9861_BF_BSSDCHT= 0x5c43,    /*!< BSS hold time (reducing DCMCC)                     */
    TFA9861_BF_BSSDCS= 0x5c81,    /*!< Battery supply safeguard steepness (reducing DCMCC) */
    TFA9861_BF_BSSDCRL= 0x5ca2,    /*!< BSS allowed reduction level (reducing DCMCC)       */
    TFA9861_BF_DCLIPFLS= 0x5cd1,    /*!< Select source for BSS flag                         */
    TFA9861_BF_BSSBYDB= 0x5cf0,    /*!< Bypass the effect of BSS on boost voltage          */
    TFA9861_BF_DCMCC = 0x5d04,    /*!< Battery current limiter initial value              */
    TFA9861_BF_TDMSPKG= 0x5f54,    /*!< TDM signal attenuation                             */
    TFA9861_BF_IPM   = 0x60e1,    /*!< Idle-power mode control                            */
    TFA9861_BF_NMSEG = 0x6280,    /*!< Amplifier normal drive  mode                       */
    TFA9861_BF_LDMSEG= 0x62b0,    /*!< Amplifier low-drive   mode                         */
    TFA9861_BF_LDM   = 0x63c1,    /*!< Low-drive mode detector control                    */
    TFA9861_BF_RCVM  = 0x63e1,    /*!< Handset/Receiver mode                              */
    TFA9861_BF_VBATHOLD= 0x6555,    /*!< Select hold time for VBAT(min./max.)               */
    TFA9861_BF_VBATMAX= 0x65b0,    /*!< Select between vbat minimum or maximum for Chip Sense output on TDM  VBAT(min./max.) */
    TFA9861_BF_TDMSRCMAP= 0x6802,    /*!< TDM source mapping                                 */
    TFA9861_BF_TDMSRCAS= 0x6842,    /*!< Sensed value A                                     */
    TFA9861_BF_TDMSRCBS= 0x6872,    /*!< Sensed value B                                     */
    TFA9861_BF_TDMSRCACLIP= 0x68a1,    /*!< Clip flag information with combined clip flag      */
    TFA9861_BF_TDMSRCCS= 0x6902,    /*!< Sensed value C                                     */
    TFA9861_BF_TDMSRCDS= 0x6932,    /*!< Sensed value D                                     */
    TFA9861_BF_TDMSRCES= 0x6962,    /*!< Sensed value E                                     */
    TFA9861_BF_TDMVBAT= 0x6990,    /*!< Select vbat to return to TDM interface             */
    TFA9861_BF_REFCKMULT= 0x6c70,    /*!< PLL ref clock selection                            */
    TFA9861_BF_CSVOFFLDM= 0x6c80,    /*!< Gating of current and voltage sense in low-drive mode  */
    TFA9861_BF_IPMS  = 0x6e00,    /*!< Idle-power mode                                    */
    TFA9861_BF_LVLCLPPWM= 0x6f72,    /*!< Clip detect threshold control                      */
    TFA9861_BF_DCIE  = 0x7060,    /*!< Adaptive boost mode                                */
    TFA9861_BF_DCNS  = 0x7400,    /*!< Disable the noise shaper control for the DC-DC control. */
    TFA9861_BF_DCNSRST= 0x7410,    /*!< Disable the noise-shaper reset control when an 8-bit value is used for the DC-DC control. */
    TFA9861_BF_DCOFFSET= 0x7424,    /*!< Boost headroom  offset                             */
    TFA9861_BF_DCDCSELOFF= 0x7470,    /*!< Selection of  of the dcdc calibration              */
    TFA9861_BF_DCHOLD= 0x7494,    /*!< Hold time for booster                              */
    TFA9861_BF_DCINT = 0x74e0,    /*!< Selection of data for adaptive boost algorithm, effective only when DCIE is set to 1 */
    TFA9861_BF_DCTRIP= 0x7509,    /*!< 1st adaptive boost trip level, effective only when DCIE is set to 1 */
    TFA9861_BF_DCTRIPT= 0x75a4,    /*!< Booster headroom gain, increasing headroom when signal amplitude increases */
    TFA9861_BF_BYPDCLPF= 0x75f0,    /*!< Bypass control of DC-DC control low-pass filter for quantization noise suppression */
    TFA9861_BF_DCVOS = 0x7687,    /*!< Maximum boost voltage                              */
    TFA9861_BF_MUSMODE= 0x7cc0,    /*!< Music mode                                         */
    TFA9861_BF_LNM   = 0x7ce1,    /*!< Low Noise mode control when in music mode          */
    TFA9861_BF_DCPTC = 0x8401,    /*!< Voltage sense dc speaker protection time           */
    TFA9861_BF_DCPL  = 0x842c,    /*!< Voltage sense dc speaker protection level          */
    TFA9861_BF_DCPROT= 0x84f0,    /*!< Voltage sense dc speaker protection enable         */
    TFA9861_BF_DCFREQ= 0x8771,    /*!< Decimator dc block filter cut off frequency  selection  */
    TFA9861_BF_DCFLTE= 0x8790,    /*!< Control for enabling the DC blocking filter for voltage and current sense */
    TFA9861_BF_EFUSEK= 0xa107,    /*!< EFUSE KEY2 register                                */
    TFA9861_BF_KEY1LOCKED= 0xa200,    /*!< Indicates KEY1 is locked                           */
    TFA9861_BF_KEY2LOCKED= 0xa210,    /*!< Indicates KEY2 is locked                           */
    TFA9861_BF_UVPSET= 0xb103,    /*!< Programmable UVP level                             */
    TFA9861_BF_PLLPDIV= 0xc934,    /*!< PLL PDIV when pll_use_direct_ctrls set to 1        */
    TFA9861_BF_PLLNDIV= 0xc987,    /*!< PLL NDIV when pll_use_direct_ctrls set to 1        */
    TFA9861_BF_PLLMDIV= 0xca0f,    /*!< PLL MDIV in PLL when pll_use_direct_ctrls set to 1 */
    TFA9861_BF_DCDIS = 0xce30,    /*!< DCDC on/off                                        */
    TFA9861_BF_PLLSTRTM= 0xce42,    /*!< PLL startup time selection control                 */
    TFA9861_BF_SWPROFIL= 0xe00f,    /*!< Software profile data                              */
    TFA9861_BF_SWVSTEP= 0xe10f,    /*!< Software vstep information                         */
    TFA9861_BF_ADC11GAIN= 0xf5a5,    /*!< Adc11b gain compensation setting, compensate factor (2's complement) */
} tfa9861BfEnumList_t;
#define TFA9861_NAMETABLE static tfaBfName_t Tfa9861DatasheetNames[]= {\
   { 0x0, "PWDN"},    /* Power-down selection                              , */\
   ...
   { 0xd0, "AMPQOKEN"},    /* Rsponse to Qpump OK flag                          , */\
   ...
   { 0x160, "MUTETO"},    /* Timeout mute sequence                             , */\
   ...
   { 0x247, "FRACTDEL"},    /* V/I fractional delay                              , */\
   { 0x30f, "REV"},    /* Product                                           , */\
   { 0x400, "REFCKEXT"},    /* PLL external reference clock                      , */\
   ...
   { 0x705, "VGAINDELS"},    /* VS gain  delay step 1/256fs                       , */\
   { 0x761, "VGAINDELL"},    /* VS gain  delay step 1/16fs                        , */\
   ...
   { 0x1140, "LNMS"},    /* Device in low-noise mode                          , */\
   { 0x1150, "FWRMS"},    /* Device in follower mode                           , */\
   { 0x1160, "BSTMS"},    /* Device in boost mode                              , */\
   { 0x1170, "PLLS"},    /* PLL lock                                          , */\
   { 0x1180, "TDMLUTER"},    /* TDM LUT error                                     , */\
   { 0x1190, "SWS"},    /* Amplifier output status                           , */\
   { 0x11a0, "AMPS"},    /* Amplifier enable status                           , */\
   { 0x11b0, "AREFS"},    /* References enable status                          , */\
   { 0x11c0, "CLIPS"},    /* Amplifier clipping status                         , */\
   { 0x11d0, "PMOSS"},    /* VBAT to VBST switch PMOS state                    , */\
   { 0x11e0, "VGBS"},    /* Vddp greater than vbat status                     , */\
   { 0x11f0, "FLGBSS"},    /* BSS flag status                                   , */\
   ...
   { 0x12e0, "LDMS"},    /* Device in low-drive mode                          , */\
   ...
   { 0x4880, "IEBODNOK"},    /* Enable interrupt brown-out detected               , */\
   ...
   { 0x4c80, "IPOBODNOK"},    /* Interrupt polarity brown-out detected             , */\
   ...
   { 0x5150, "HPFBYP"},    /* Bypass High Pass Filter in audio path             , */\
   ...
   { 0x5450, "AMPDRV"},    /* Drive setting of AMP powerstage when amp_use_direct_ctrls , */\
   { 0x5481, "AMPSLP"},    /* Amplifier slope control                           , */\
   { 0x54a1, "BSTSLP"},    /* Booster slope control                             , */\
   { 0x5a00, "BSSMVBS"},    /* Min._vbat source select                           , */\
   ...
   { 0x5d04, "DCMCC"},    /* Battery current limiter initial value             , */\
   { 0x5f54, "TDMSPKG"},    /* TDM signal attenuation                            , */\
   { 0x60e1, "IPM"},    /* Idle-power mode control                           , */\
   { 0x6280, "NMSEG"},    /* Amplifier normal drive  mode                      , */\
   { 0x62b0, "LDMSEG"},    /* Amplifier low-drive   mode                        , */\
   ...
   { 0x6c70, "REFCKMULT"},    /* PLL ref clock selection                           , */\
   { 0x6c80, "CSVOFFLDM"},    /* Gating of current and voltage sense in low-drive mode , */\
   { 0x6e00, "IPMS"},    /* Idle-power mode                                   , */\
   { 0x6f72, "LVLCLPPWM"},    /* Clip detect threshold control                     , */\
   { 0x7060, "DCIE"},    /* Adaptive boost mode                               , */\
   { 0x7400, "DCNS"},    /* Disable the noise shaper control for the DC-DC control., */\
   { 0x7410, "DCNSRST"},    /* Disable the noise-shaper reset control when an 8-bit value is used for the DC-DC control., */\
   { 0x7424, "DCOFFSET"},    /* Boost headroom  offset                            , */\
   { 0x7470, "DCDCSELOFF"},    /* Selection of  of the dcdc calibration             , */\
   ...
   { 0x75a4, "DCTRIPT"},    /* Booster headroom gain, increasing headroom when signal amplitude increases, */\
   { 0x75f0, "BYPDCLPF"},    /* Bypass control of DC-DC control low-pass filter for quantization noise suppression, */\
   ...
   { 0x8771, "DCFREQ"},    /* Decimator dc block filter cut off frequency  selection , */\
   { 0x8790, "DCFLTE"},    /* Control for enabling the DC blocking filter for voltage and current sense, */\
   ...
   { 0xf5a5, "ADC11GAIN"},    /* Adc11b gain compensation setting, compensate factor (2's complement), */\
   { 0xffff,"Unknown bitfield enum" }   /* not found */\
};

#define TFA9861_BITNAMETABLE static tfaBfName_t Tfa9861BitNames[]= {\
   { 0x0, "powerdown"},    /* Power-down selection                              , */\
   ...
   { 0xd0, "enbl_amp_qpump_ok"},    /* Rsponse to Qpump OK flag                          , */\
   ...
   { 0x160, "disable_mute_time_out"},    /* Timeout mute sequence                             , */\
   ...
   { 0x1e0, "int_enable"},    /* Pad INT enable for QFN device                     , */\
   { 0x1f0, "datao_enable"},    /* Pad DATAO enable  for QFN device                  , */\
   { 0x203, "audio_fs"},    /* Sample rate (Fs)                                  , */\
   { 0x247, "cs_frac_delay"},    /* V/I fractional delay                              , */\
   { 0x30f, "product"},    /* Product                                           , */\
   { 0x400, "pll_clkin_sel"},    /* PLL external reference clock                      , */\
   ...
   { 0x4c2, "clk_pwm_dly_sel"},    /* Delay on clock da_clk4096fs to tzdac              , */\
   { 0x4f0, "gate_clk_in_idle"},    /* Enable clock gating in idle-power mode            , */\
   ...
   { 0x520, "sel_pll_freq"},    /* PLL VCO  frequency select when pwm at 384KHz      , */\
   { 0x607, "category"},    /* Product category                                  , */\
   { 0x687, "version"},    /* Version                                           , */\
   { 0x705, "cs_gain_delay_256fs"},    /* VS gain  delay step 1/256fs                       , */\
   { 0x761, "cs_gain_delay_16fs"},    /* VS gain  delay step 1/16fs                        , */\
   ...
   { 0x1140, "flag_low_noise_mode"},    /* Device in low-noise mode                          , */\
   { 0x1150, "flag_follower_mode"},    /* Device in follower mode                           , */\
   { 0x1160, "flag_boost_mode"},    /* Device in boost mode                              , */\
   { 0x1170, "flag_pll_lock"},    /* PLL lock                                          , */\
   { 0x1180, "flag_tdm_lut_error"},    /* TDM LUT error                                     , */\
   { 0x1190, "flag_engage"},    /* Amplifier output status                           , */\
   { 0x11a0, "flag_enbl_amp"},    /* Amplifier enable status                           , */\
   { 0x11b0, "flag_enbl_ref"},    /* References enable status                          , */\
   { 0x11c0, "flag_clip"},    /* Amplifier clipping status                         , */\
   { 0x11d0, "flag_low_drive_mode"},    /* VBAT to VBST switch PMOS state                    , */\
   { 0x11e0, "flag_vddp_gt_vbat"},    /* Vddp greater than vbat status                     , */\
   { 0x11f0, "flag_bss"},    /* BSS flag status                                   , */\
   ...
   { 0x12e0, "flag_active_pst_sections"},    /* Device in low-drive mode                          , */\
   ...
   { 0x4880, "int_enable_flag_bod_vddd_nok"},    /* Enable interrupt brown-out detected               , */\
   ...
   { 0x4c80, "int_polarity_flag_bod_vddd_nok"},    /* Interrupt polarity brown-out detected             , */\
   ...
   { 0x5150, "bypass_hp"},    /* Bypass High Pass Filter in audio path             , */\
   ...
   { 0x5450, "amp_drive"},    /* Drive setting of AMP powerstage when amp_use_direct_ctrls , */\
   { 0x5460, "amp_fpwm_hybrid"},    /* Enable the hybrid mode digital at 768k at analog at 384k, */\
   { 0x5470, "amp_lpf_bypass"},    /* Bypass the CIFF low pass filter (better stability / higher noise), */\
   ...
   { 0x5800, "lnm_step"},    /* Number of gain step during lnm transition         , */\
   ...
   { 0x5891, "force_ns_to_zero"},    /* Number of zero to apply after the noise shaper to avoid pop, */\
   { 0x58b2, "dly_attenuate"},    /* Delay on attenuate signal                         , */\
   { 0x58f0, "byp_post_mult4"},    /* Bypass post divider by 4                          , */\
   { 0x5907, "dpwm_dc_in"},    /* Dc_level input to derive dpwm signals             , */\
   { 0x5987, "cmff_dc_in"},    /* Dc_level input to derive cmff signals             , */\
   { 0x5a00, "bss_minvbat_select"},    /* Min._vbat source select                           , */\
   ...
   { 0x5d04, "bss_dcmcc"},    /* Battery current limiter initial value             , */\
   { 0x5d50, "bst_ocp_offset"},    /* Activate -0.3A offset in OCL/DCMCC                , */\
   { 0x5d67, "vddp_ocp_cmp"},    /* Vddp threshold to change OCP when low vddp        , */\
   ...
   { 0x6065, "idle_power_zero_lvl"},    /* Idle-power mode zero crossing detection level (TDMSPKG and INPLEV set to 0), */\
   ...
   { 0x6280, "amp_drive_normal_mode"},    /* Amplifier normal drive  mode                      , */\
   { 0x62b0, "amp_drive_low_drive_mode"},    /* Amplifier low-drive   mode                        , */\
   { 0x62c0, "byp_drive_low_drive_det"},    /* Bypass low-drive detector                         , */\
   ...
   { 0x6423, "qpump_clkdiv_bst_mode"},    /* Qpump clock  divider boost mode                   , */\
   { 0x6462, "qpump_clkin_sel"},    /* Qpump clock  root selection                       , */\
   { 0x6490, "bst_pmos_sel"},    /* Control mode of the  bst pmos                     , */\
   ...
   { 0x67d0, "amp_idle_not"},    /* PST OFF pull down control when amp_use_direct_ctrls is set to 1, */\
   ...
   { 0x6c70, "pll_clkref_sel"},    /* PLL ref clock selection                           , */\
   { 0x6c80, "gate_cvs_in_ldm"},    /* Gating of current and voltage sense in low-drive mode , */\
   { 0x6c90, "amp_lpf_auto"},    /* Amplifer low path filter automatically disable in  low-drive mode, */\
   { 0x6ca5, "spare_out"},    /* Spare control bits for future use                 , */\
   ...
   { 0x7101, "bst_drive"},    /* Drive setting of Booster powerstage               , */\
   { 0x7130, "bst_ocl_disable"},    /* Disable DCMCC                                     , */\
   { 0x7400, "dcdc_disable_ns"},    /* Disable the noise shaper control for the DC-DC control., */\
   { 0x7410, "dcdc_disable_mod8bit"},    /* Disable the noise-shaper reset control when an 8-bit value is used for the DC-DC control., */\
   { 0x7424, "boost_trip_lvl_offset"},    /* Boost headroom  offset                            , */\
   { 0x7470, "sel_calbr_vout_offset"},    /* Selection of  of the dcdc calibration             , */\
   ...
   { 0x75a4, "boost_trip_lvl_track"},    /* Booster headroom gain, increasing headroom when signal amplitude increases, */\
   { 0x75f0, "bypass_dcdc_lpf"},    /* Bypass control of DC-DC control low-pass filter for quantization noise suppression, */\
   ...
   { 0x7821, "bst_nomfreq"},    /* Booster nominal frequency in voltage regulation   , */\
   { 0x7b02, "ns_hp2ln_criterion"},    /* Number of zeros in noise shaper to swap from high power to Low-noise mode, */\
   { 0x7b32, "ns_ln2hp_criterion"},    /* Number of zeros in noise shaper to swap from Low-noise mode to  high power, */\
   { 0x7b65, "low_noise_zero_lvl"},    /* Low-noise mode   zero crossing  detection level   , */\
   { 0x7bc0, "ns_hp2ln_zero_mode"},    /* Zero detection mode from entering in Low-noise mode  , */\
   { 0x7bd0, "ns_ln2hp_zero_mode"},    /* Zero detection mode from leaving in Low-noise mode  , */\
   ...
   { 0x7d05, "low_noise_max_lvl"},    /* Low-noise mode max  amplitude trigger level       , */\
   ...
   { 0x8771, "vs_cut_off_freq"},    /* Decimator dc block filter cut off frequency  selection , */\
   ...
   { 0xa710, "cfg_hw_mode"},    /* Low to use standard registers instead of shadow content in hardware mode for more flexibility , */\
   ...
   { 0xbf07, "dft"},    /* 8 bits data for dft control                       , */\
   ...
   { 0xc0f0, "clk_atb_sel"},    /* Used to select the source of clk_atb(for testing) , */\
   ...
   { 0xc6e1, "int_pupd"},    /* INT pad pull-up/pull-down control                 , */\
   ...
   { 0xc8a2, "pll_cp_ib_trim"},    /* Connect to rg_pl200m_cp_ib_trim, pl200m charge pump current bias trim code, */\
   { 0xc8d0, "pll_lf_ord4_sel"},    /* PLL Filter order selection                        , */\
   { 0xc902, "pll_vco_gm_rs_trim"},    /* Connect to rg_pl200m_vco_gm_rs_trim, pl200m vco gm source resistor of gm selection word, */\
   ...
   { 0xcc80, "ana_spare_not_used"},    /* Signal Reused for analog fix, register not connected to anything , */\
   { 0xcc90, "vddp_rdiv_sel"},    /* ADC11 VDDP predivider selection                   , */\
   { 0xcca5, "ana_spare_nokey"},    /* Reseved for analog metal ECO                      , */\
   { 0xcd07, "pll_dpll_itrim_manual"},    /* Valid when bypass the DPLL                        , */\
   { 0xcd87, "ana_spare_key1"},    /* Reseved for analog metal ECO                      , */\
   { 0xce00, "bod_sel"},    /* BOD thresold selection                            , */\
   { 0xce10, "bst_clamp_vref_sel"},    /* vfbck clamp                                       , */\
   ...
   { 0xcfc0, "adc11_clk_sel"},    /* Adc11 clock selection                             , */\
   ...
   { 0xd4a4, "bst_ocp"},    /* Control da_bst_ocp when bst_use_direct_ctrls is set to 1, */\
   ...
   { 0xd5d1, "cvs_sdm_offset"},    /* Programmed offset of OTA to push idle tones       , */\
   { 0xd5f0, "cvs_csitf_atb_sel"},    /* Select sdm input in test mode                     , */\
   ...
   { 0xd700, "amp_hv_gate_ls"},    /* Testsignal PST connect gate_ls to vatb_hv (HVTEST), */\
   ...
   { 0xd760, "amp_test_bist_ocp"},    /* Enable amp OCP test mode                          , */\
   ...
   { 0xd8e0, "bst_idac_offset"},    /* Select boost fb_idac offset.                      , */\
   ...
   { 0xd930, "bst_clamp_test"},    /* Clamp test mode                                   , */\
   { 0xd940, "bst_hv_gate_ls"},    /* Connect gate low side to atb analog test bus      , */\
   { 0xd950, "bst_test_vddl1v8"},    /* Test bit for vddl1v8 observability                , */\
   { 0xd960, "bst_test_idac_current"},    /* Test bit for OCL reference current observability  , */\
   ...
   { 0xda20, "amp_tzdac_idc_sel"},    /* Tzdac  gain selection when amp_use_direct_ctrls is1, */\
   ...
   { 0xda50, "bst_test_ocp"},    /* Toggle around OCP level in CVI mode               , */\
   { 0xda61, "bst_nomfreq_oc"},    /* Boost frequency in current regulation mode( DCMCC triggered), */\
   { 0xda80, "bst_toffmin_ctrl"},    /* Toff min control for voltage mode switching       , */\
   { 0xda90, "bst_vddpgt5v0_detect_en"},    /* Enable limiter in booster LS gate driver when VDDP<5V, */\
   { 0xdaa0, "amp_vddpgt5v0_detect_en"},    /* Enable limiter in amplifier LS gate driver when VDDP<5V, */\
   { 0xdab2, "qpump_vssq_trim"},    /* Force VREF-VDDP higher than 5V to verifybenefit on efficiency, */\
   { 0xdae0, "bst_lpfm_en"},    /* Enable DC-DC converter low-power follower mode for efficiency improvement at low-power, */\
   { 0xdaf0, "ciff_ibias_sel"},    /* Ciff aop bandwidth                                , */\
   ...
   { 0xdb50, "atbn_test1"},    /* Connect atbn to outside world (TEST2)             , */\
   ...
   { 0xdca0, "atbp_vref1p2"},    /* Connect 1.2V band-gap to outside world (TEST1)    , */\
   { 0xdcb2, "atb_ref_spare"},    /* ATB REF spare                                     , */\
   ...
   { 0xdf03, "atb_bst_spare"},    /* ATB BST spare                                     , */\
   { 0xdfc0, "atb_amp_spare"},    /* ATB AMP  spare                                    , */\
   { 0xe00f, "sw_profile"},    /* Software profile data                             , */\
   { 0xe10f, "sw_vstep"},    /* Software vstep information                        , */\
   { 0xf003, "amp_ochp_trim"},    /* Trim OCP level AMP PST 2's compliment (key1 protected), */\
   { 0xf043, "amp_ochn_trim"},    /* Trim OCP level AMP PST 2's compliment (key1 protected), */\
   { 0xf083, "amp_oclp_trim"},    /* Trim OCP level AMP PST 2's compliment (key1 protected), */\
   { 0xf0c3, "amp_ocln_trim"},    /* Trim OCP level AMP PST 2's compliment (key1 protected), */\
   { 0xf103, "amp_ciff_trim"},    /* Trim capacitors of CIFF integrators               , */\
   { 0xf143, "bst_ocl_trim"},    /* Trim OCP level (low side)                         , */\
   { 0xf183, "bst_och_trim"},    /* Trim OCP level (high side)                        , */\
   { 0xf1c3, "bst_freqtrim"},    /* Trim COT timer frequency                          , */\
   { 0xf207, "calibr_vout_offset"},    /* DCDC offset calibration 2's complement (key1 protected), */\
   { 0xf280, "lock_bypass_clipper"},    /* Disable function bypass_clipper                   , */\
   { 0xf290, "lock_max_dcdc_voltage"},    /* Limit Max. DCDC voltage                           , */\
   { 0xf2a2, "otp_versions"},    /* OTP VERSION                                       , */\
   { 0xf2d0, "otp_i2c_id"},    /* I2c id selection                                  , */\
   { 0xf2e1, "spare_f2_15_14"},    /* SPARE                                             , */\
   { 0xf303, "bgr_vtrim"},    /* Trim BGR 900mV reference voltage(2s-complement)   , */\
   { 0xf343, "bgr_itrim"},    /* Trim BGR reference current                        , */\
   { 0xf384, "amp_rfb_trim"},    /* Trim amp rfb                                      , */\
   { 0xf3d1, "spare_f3_14_13"},    /* Spare                                             , */\
   { 0xf3f0, "ate_test_completed"},    /* Report status of ATE test                         , */\
   { 0xf407, "calibr_osc_delta_ndiv"},    /* Clk_range_check calibration value (2s-complement) , */\
   { 0xf487, "calibr_cs_gain"},    /* Current sense gain (signed two's complement format), */\
   { 0xf503, "calibr_gain"},    /* HW gain module (2's complement)                   , */\
   { 0xf545, "calibr_offset"},    /* Offset for amplifier, HW gain module (2's complement), */\
   { 0xf5a5, "adc11_gain_comp"},    /* Adc11b gain compensation setting, compensate factor (2's complement), */\
   { 0xf607, "calibr_temp_offset"},    /* Temperature offset 2's compliment (key1 protected), */\
   { 0xf686, "calibr_temp_gain"},    /* Temperature gain 2's compliment (key1 protected)  , */\
   { 0xf6f0, "hot_test_stage_completed"},    /* Report status of hot test stage                   , */\
   { 0xf706, "htol_iic_addr"},    /* 7-bit I2C address to be used during HTOL testing  , */\
   { 0xf770, "htol_iic_addr_en"},    /* HTOL I2C address enable control                   , */\
   { 0xf783, "otp_qpump_clkdiv_follower_mode"},    /* Qpump clock  divider follower mode                , */\
   { 0xf7c3, "otp_qpump_clkdiv_bst_mode"},    /* Qpump clock  divider boost mode                   , */\
   { 0xf804, "otp_cmff_ctrl_nskip"},    /* Skip or shorten CMFF pulses in 4096fs cycles to create headroom at the bottom, */\
   { 0xf854, "otp_boost_trip_lvl_offset"},    /* Boost headroom  Offset                            , */\
   { 0xf8a4, "otp_boost_trip_lvl_track"},    /* Booster headroom gain, increasing headroom when signal amplitude increase, */\
   { 0xf8f0, "spare_f8_15"},    /* SPARE                                             , */\
   { 0xf909, "otp_boost_trip_lvl_1st"},    /* 1st Adaptive boost trip level, effective only when DCIE is set to 1, */\
   { 0xf9a1, "otp_amp_pst_bbm"},    /* Amplifier break-before-make delay                 , */\
   { 0xf9c1, "otp_bst_pst_bbm"},    /* Booster break-before-make delay                   , */\
   { 0xf9e0, "hw_mode"},    /* Enable hardware mode                              , */\
   { 0xf9f0, "qfn_mode"},    /* Enable hardware mode                              , */\
...
enum tfa9861_irq {
	tfa9861_irq_stvdds = 0,
	tfa9861_irq_stbstoc = 1,
	tfa9861_irq_stotds = 2,
	tfa9861_irq_stocpr = 3,
	tfa9861_irq_stuvds = 4,
	tfa9861_irq_sttdmer = 5,
	tfa9861_irq_stnoclk = 6,
	tfa9861_irq_stdcth = 7,
	tfa9861_irq_stbodnok = 8,
	tfa9861_irq_stcoor = 9,
	tfa9861_irq_stovds = 10,
	tfa9861_irq_stqpfail = 11,
	tfa9861_irq_max = -1,
	tfa9861_irq_all = -1 /* all irqs */};

#define TFA9861_IRQ_NAMETABLE static tfaIrqName_t tfa9861_irq_names[]= {\
	{0, "STVDDS"},\
	{1, "STBSTOC"},\
	{2, "STOTDS"},\
	{3, "STOCPR"},\
...
#endif /* _TFA9861_TFAFIELDNAMES_H */
